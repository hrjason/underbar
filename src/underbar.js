(function() {
  ...
  _.each = function(collection, iterator) {
      if (Array.isArray(collection)) {
        ...
        return 'Neither an object or array';
      }
  };
  ...
  */
  ...
  // TIP: see if you can re-use _.filter() here, without simply
  // copying code in and modifying it
    var result = _.filter(collection, function(someValue) {
 ...
 _.memoize = function(func) {
    ...
    return function(){
      if(!cache[arguments]) {
        if (cache[arguments[0]] !== undefined)
          cache[arguments[0]] = cache[arguments[0]];
        else 
  ...
  // it with the arguments sueter. For example _.delay(someFunction, 500, 'a', 'b') will
  // call someFunction('a', 'b') after 500ms
  _.delay = function(func, wait) {
    //var args = slice.call(arguments, 2); // From Underbar.js however does not work.  
    var args = Array.prototype.slice.call(arguments, 2); //Stackoverflow solution...
  ...
  /**
   * ADVANCED COLLECTION OPERApplied.
  //
  ...
  _.shuffle = function(array) {
    //argument  array [2,1,3,5]
    //Fisher-Yates Shuffle Algorithm 
    //Copy array to a new array
    var shuffled = array.slice(0);
    //start for loop moving from the end of the array to the beginning
    for (var i = shuffled.length - 1; i > 0; i--) {
        //Randomize J from 0 - end of array length
        //Example j = 3, i = 4
        var j = Math.floor(Math.random() * (i + 1));
        //make variable temp equal to the value of the iterated array value. 
        //Example: temp = 5
        var temp = shuffled[i];
        //array[4] = array[3] meaning array[4] = 3
